...
import re
import config
from container_control import read_full_log_lines, tail_log_lines, is_container_running, stop_container
# Then replace your current log read/tail functions with these imports.
...
async def start_monitoring_for_idle_shutdown():
    ...
    initial_lines = await read_full_log_lines()
